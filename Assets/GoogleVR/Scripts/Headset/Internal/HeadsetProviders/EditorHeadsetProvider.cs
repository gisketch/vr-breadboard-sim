...
#pragma warning disable CS0618 // 'PlayerSettings.VRDaydream.minimumSupportedHeadTracking' is obsolete: 'This API is obsolete, and should no longer be used. More information with the latest recommendation can be found here <https://developers.google.com/vr/develop/unity/get-started-android>.'
                        = UnityEditor.PlayerSettings.VRDaydream.minimumSupportedHeadTracking;
#pragma warning restore CS0618 // 'PlayerSettings.VRDaydream.minimumSupportedHeadTracking' is obsolete: 'This API is obsolete, and should no longer be used. More information with the latest recommendation can be found here <https://developers.google.com/vr/develop/unity/get-started-android>.'
                UnityEditor.XR.Daydream.SupportedHeadTracking maxTrackingState
#pragma warning disable CS0618 // 'PlayerSettings.VRDaydream.maximumSupportedHeadTracking' is obsolete: 'This API is obsolete, and should no longer be used. More information with the latest recommendation can be found here <https://developers.google.com/vr/develop/unity/get-started-android>.'
                        = UnityEditor.PlayerSettings.VRDaydream.maximumSupportedHeadTracking;
#pragma warning restore CS0618 // 'PlayerSettings.VRDaydream.maximumSupportedHeadTracking' is obsolete: 'This API is obsolete, and should no longer be used. More information with the latest recommendation can be found here <https://developers.google.com/vr/develop/unity/get-started-android>.'
